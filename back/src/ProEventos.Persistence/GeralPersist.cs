...
namespace ProEventos.Persistence
{
    public class GeralPersist : IGeralPersist
    {
        ...
        public GeralPersist(ProEventosContext context) => _context = context;
        ...
        public async Task<bool> SaveChangesAsync() => (await _context.SaveChangesAsync()) > 0; //houve alteração
